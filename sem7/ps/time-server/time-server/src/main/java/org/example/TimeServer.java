    ...
    public void start() {
        try {
            ...
            while (interfaces.hasMoreElements()) {
                ...
                // For some reason networkInterface.isVirtual() did not work
                if (networkInterface.isUp() && !networkInterface.isLoopback() && !networkInterface.isVirtual()) {
                    ...
                    while (addresses.hasMoreElements()) {
                        ...
                        // Eliminate virtual address from getHostAddress
                        if (address instanceof Inet4Address && address.getHostAddress().equals("192.168.0.12")) {
                ...
                while (true) {
                    ...
                    if (receivedMessage.equals(DISCOVER_MESSAGE)) {
                        ...
                        for (ServerThread serverThread : serverThreads) {
                            ...
                            System.out.println("Creating offer for TCP connection under these addresses: \n " + offerMessage);
                            ...
                            System.out.println("Sending offer to client: " + clientAddress +  "\n" + "to port from DISCOVER message came: " + packet.getPort());
